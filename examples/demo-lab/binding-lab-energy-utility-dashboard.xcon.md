...
```xcon-chain-fixture
{
  "record": {
    ...
    "subtitle": "Energy savings, water/gas consumption, meter alerts, and scheduled site visits.",
    "updatedAt": "runner idle",
    "status": "Waiting for workflow run",
    "statusColor": "#94a3b8",
    "summary": "Utility consumption, service-region map, forecast chart, and meter workqueue.",
    "theme": {
      "bg": "#ecfdf5",
      "panel": "#064e3b",
      "card": "#ffffff",
    ...
    "heroImage": "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=900&q=80",
    "metrics": {
      "revenue": 1210,
      "growth": 16,
      "health": 89
...
Energy savings, water/gas consumption, meter alerts, and scheduled site visits.
...
```xcon-sketch
screen "Energy & Utility Dashboard" 1040x720 bg #ecfdf5
...
```xcon-workflow
workflow "Energy & utility dashboard workflow"
  ingestTelemetry: callApi GET "/api/dashboard/energy-utility-dashboard/telemetry"

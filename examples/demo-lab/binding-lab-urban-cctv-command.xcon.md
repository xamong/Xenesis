...
```xcon-chain-fixture
{
  "record": {
    ...
    "subtitle": "Camera wall, map markers, traffic incident queue, and field dispatch status.",
    "updatedAt": "runner idle",
    "status": "Waiting for workflow run",
    "statusColor": "#94a3b8",
    "summary": "Traffic CCTV, static map preview, incident table, and workflow-fed regional monitoring.",
    "theme": {
      "bg": "#0f172a",
      "panel": "#1e293b",
      "card": "#f8fafc",
    ...
    "heroImage": "https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&w=900&q=80",
    "metrics": {
      "revenue": 23,
      "growth": 7,
      "health": 84
...
Camera wall, map markers, traffic incident queue, and field dispatch status.
...
```xcon-sketch
screen "Urban CCTV Command" 1040x720 bg #0f172a
  ...
  cctvWall: panel at 24 154 486 286
    bg #0f172a
    radius 18
    feed1: image at 14 14 220 120
      src "$record.heroImage"
      objectFit "cover"
    feed2: image at 250 14 220 120
      src "$record.heroImage"
      objectFit "cover"
    feed3: image at 14 150 220 120
      src "$record.heroImage"
      objectFit "cover"
    feed4: image at 250 150 220 120
      src "$record.heroImage"
      objectFit "cover"
  mapPanel: panel at 534 154 482 286
    bg #ffffff
    radius 18
    mapView: map at 18 18 446 250
      latitude 37.5665
      longitude 126.978
      zoom 12
      markers $mapMarkers
  incidentGrid: panel at 24 464 992 116
    bg #ffffff
    radius 18
    grid: spanGrid at 18 16 956 82
...
```xcon-workflow
workflow "Urban CCTV command workflow"
  ingestTelemetry: callApi GET "/api/dashboard/urban-cctv-command/telemetry"

```xcon-demo
demo "Sales comparison dashboard"
mode "binding-lab"
autoplay false
stream.speed "guided"
workflow.run true
...
{
  "record": {
    "title": "Sales Comparison Board",
    "subtitle": "Button-driven product comparison, sales charts, and period summary grid.",
    "updatedAt": "runner idle",
    "status": "Waiting for workflow run",
    "statusColor": "#94a3b8",
    "summary": "Long-period sales comparison dashboard with charts, tables, and workflow approval state.",
    "theme": {
      "bg": "#fff7ed",
      "panel": "#7c2d12",
      "card": "#fffbeb",
    ...
    "heroImage": "https://images.unsplash.com/photo-1556745757-8d76bdb6984b?auto=format&fit=crop&w=900&q=80",
    "metrics": {
      "revenue": 896400,
      "growth": 17,
      "health": 88
...
Button-driven product comparison, sales charts, and period summary grid.
...
```xcon-sketch
screen "Sales Comparison Board" 1040x720 bg #fff7ed
...
```xcon-workflow
workflow "Sales comparison dashboard workflow"
  ingestTelemetry: callApi GET "/api/dashboard/sales-comparison-dashboard/telemetry"

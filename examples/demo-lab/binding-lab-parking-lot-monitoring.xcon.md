...
{
  "record": {
    "title": "Parking Area Monitor",
    "subtitle": "Slot occupancy, gate camera, illegal parking alerts, and control-room workflow.",
    "updatedAt": "runner idle",
    "status": "Waiting for workflow run",
    "statusColor": "#94a3b8",
    "summary": "Parking occupancy, vehicle camera, slot grid, and incident workflow.",
    "theme": {
      "bg": "#f7fee7",
      "panel": "#365314",
      "card": "#ffffff",
    ...
    "heroImage": "https://images.unsplash.com/photo-1506521781263-d8422e82f27a?auto=format&fit=crop&w=900&q=80",
    "metrics": {
      "revenue": 41,
      "growth": 18,
      "health": 76
...
Slot occupancy, gate camera, illegal parking alerts, and control-room workflow.
...
```xcon-sketch
screen "Parking Area Monitor" 1040x720 bg #f7fee7
  ...
  parkingMap: panel at 24 154 486 276
    bg #ecfccb
    radius 18
    mapTitle: label "Parking occupancy layout" at 22 18 240 24
      color #365314
      font
        size 18
        weight 800
    lot1: shape at 44 66 56 30
      bg #a3e635
      radius 6
    lot2: shape at 110 66 56 30
      bg #d9f99d
      radius 6
    lot3: shape at 176 66 56 30
      bg #a3e635
      radius 6
    lot4: shape at 242 66 56 30
      bg #d9f99d
      radius 6
    lot5: shape at 308 66 56 30
      bg #a3e635
      radius 6
    lot6: shape at 374 66 56 30
      bg #ef4444
      radius 6
    carCam: image at 44 128 386 120
...
```xcon-workflow
workflow "Parking lot monitoring workflow"
  ingestTelemetry: callApi GET "/api/dashboard/parking-lot-monitoring/telemetry"

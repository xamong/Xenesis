exports.activate = function activate(api) {
  api.registerCommand('xenesis-desk.core-tools.openXamongCode', function openXamongCode() {
    api.openTool('xenesis-desk.core-tools.xamong-code-chat');
  });
  ...
  api.registerCommand('xenesis-desk.core-tools.openPreview', function openPreview() {
    api.openTool('xenesis-desk.core-tools.xapp-preview');
  });

  api.registerCommand('xenesis-desk.core-tools.openActivityTimeline', function openActivityTimeline() {
    api.openTool('xenesis-desk.core-tools.activity-timeline');
  });

  api.registerCommand('xenesis-desk.core-tools.openNetworkMonitor', function openNetworkMonitor() {

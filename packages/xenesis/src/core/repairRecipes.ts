...
const recipes: Record<VerificationFailureCauseId, FailureRepairRecipe> = {
  ...
  client_runtime_error: {
    ...
    successCriteria: [
      "pageErrors is 0.",
      "The previous client error text no longer appears in verification output."
    ],
    stopCriteria: [
  ...
  process_cleanup: {
    ...
    successCriteria: [
      "No open-handle or child cleanup warning remains.",
      "diagnostics exits deterministically."
    ],
    stopCriteria: [
  ...
  verification_failure: {
    ...
    successCriteria: [
      "The failed verification passes.",
      "No new blocking verification failure appears."
    ],
    stopCriteria: [

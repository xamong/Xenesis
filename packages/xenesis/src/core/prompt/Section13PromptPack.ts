...
export const section13VolatileReferenceNames = [
  "mcp_instructions"
] as const;
...
export function createSection13PromptRegistry(options: CreateSection13PromptBlocksOptions): PromptSectionRegistry {
  ...
  return new PromptSectionRegistry([
    ...
    id: index < section13StaticReferenceNames.length
    ...
    content: "",
    priority: index < section13StaticReferenceNames.length
...
export function auditSection13Prompt(
...
export function toSection13PromptOracleObservation(prompt: ComposedSystemPrompt) {
  return {
    ...
    visibleResult: "section order, boundary sentinel, and cache-break sections match the reference section 13 prompt stack"
  };
}

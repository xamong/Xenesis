...
const remoteTriggerInputSchema = z.object({
  ...
  trigger_id: z.string().regex(/^[\w-]+$/u).optional(),
...
export function createRemoteTriggerTool(dependencies: RemoteTriggerDependencies = {}): Tool<RemoteTriggerInput, RemoteTriggerOutput> {
  return {

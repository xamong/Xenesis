...
export type SourceFeatureParityStatus =
  | "inventory_only"
  | "mapped_without_oracle"
  | "parity_ready";
...
const referenceToolMappedWithoutOracleAnchors: SourceFeatureItem[] = [
  {
    ...
    observable: "Reference AgentTool color manager exposes fixed subagent color names and theme-color lookup; Xenesis maps bounded local agent delegation/task orchestration and does not claim source-equivalent Agent UI parity.",
    status: "mapped",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference plan-entry concept maps to Xenesis planning_start behavior with enter_plan_mode kept only as a legacy alias; no source-equivalent UI parity is claimed.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference plan-exit concept maps to Xenesis planning_finish behavior with exit_plan_mode kept only as a legacy alias; no source-equivalent UI parity is claimed.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/planModeTools.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference EnterWorktree tool identity is exposed by the EnterWorktree constant; Xenesis maps bounded local worktree entry behavior without changing existing worktree lifecycle semantics.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference ExitWorktree tool identity is exposed by the ExitWorktree constant; Xenesis maps bounded local worktree exit behavior without changing existing worktree deletion semantics.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/worktreeTools.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference SendMessage tool identity is exposed by the SendMessage constant; Xenesis maps bounded local task/agent message delivery without claiming source-equivalent conversation UI parity.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TaskCreate tool identity is exposed by the TaskCreate constant; Xenesis maps bounded local durable agent-task creation without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TaskGet tool identity is exposed by the TaskGet constant; Xenesis maps bounded local durable agent-task lookup without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/agentTaskTool.ts; src/orchestration/agentTasks.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TaskList tool identity is exposed by the TaskList constant; Xenesis maps bounded local durable agent-task listing without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/agentTaskTool.ts; src/orchestration/agentTasks.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TaskOutput tool identity is exposed by the TaskOutput constant; Xenesis maps bounded local durable agent-task output retrieval without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/agentTaskTool.ts; src/orchestration/agentTasks.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TaskStop exposes a task_id stop operation with success/failure status in its prompt; Xenesis maps bounded local durable agent-task stopping without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/agentTaskTool.ts; src/orchestration/agentTasks.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TaskUpdate tool identity is exposed by the TaskUpdate constant; Xenesis maps bounded local durable agent-task update behavior without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/agentTaskTool.ts; src/orchestration/agentTasks.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TeamCreate tool identity is exposed by the TeamCreate constant; Xenesis maps bounded local team creation without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TeamDelete tool identity is exposed by the TeamDelete constant; Xenesis maps bounded local team deletion without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/teamTools.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference TodoWrite tool identity is exposed by the TodoWrite constant; Xenesis maps bounded local todo state updates without source-equivalent oracle evidence.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
...
const referenceRequiredAnchors: SourceFeatureItem[] = [
  ...referenceToolMappedWithoutOracleAnchors,
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference-style agent launch and agent-task lifecycle contract for durable task creation, status lookup, metadata/dependency updates, stop behavior, and completed output rendering; this does not claim source-equivalent Agent UI, color, task UI, or remote worker parity.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/tools/agentTool.ts; src/tools/agentTaskTool.ts; src/orchestration/agentTasks.ts",
    referencePath: "E:/agent-anal/src/tools/AgentTool/agentColorManager.ts; E:/agent-anal/src/tools/TaskCreateTool/constants.ts",
    parityEvidence: {
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference-style local worktree lifecycle contract for name validation, durable git worktree session state, duplicate entry blocking, keep/remove exit behavior, and dirty-removal discard confirmation; this does not claim reference UI, conversation worktree switching, remote isolation, or branch/fork UI parity.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/tools/worktreeTools.ts; src/tools/worktreeSessionStore.ts; src/core/isolation/gitWorktree.ts",
    referencePath: "E:/agent-anal/src/tools/EnterWorktreeTool/constants.ts; E:/agent-anal/src/tools/ExitWorktreeTool/constants.ts",
    parityEvidence: {
  ...
  },
  {
    ...
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/core/prompt/PromptComposer.ts; src/core/prompt/Section13PromptPack.ts; src/core/AgentRuntimeFactory.ts; src/providers/anthropicProvider.ts",
  ...
  },
  {
    ...
    category: "prompt",
    source: "reference-required",
    observable: "Reference prompt sections, ordering, dynamic tail, runtime projection, and provider cache-control markers.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/core/prompt/PromptComposer.ts; src/core/prompt/Section13PromptPack.ts; src/core/AgentRuntimeFactory.ts; src/providers/anthropicProvider.ts",
    referencePath: "E:/agent-anal/src/constants/prompts.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Explicit local help command route, topic help surface, and bounded non-interactive help text without claiming full reference JSX UI parity.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Local status command reports effective provider, model, approval mode, workspace, and Xenesis home in text or JSON without probing providers.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference Usage opens the Settings UI with the Usage tab, while Xenesis summarizes local session, run report, and task usage snapshots without provider or billing probes.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference Cost uses runtime cost tracker plus subscriber or overage status, while Xenesis summarizes stored local estimates without billing API calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/usageCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference Stats opens the Stats component, while Xenesis prints local session, run report, task, schedule, and status-bucket counts.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/usageCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference Login launches ConsoleOAuthFlow and refreshes auth-dependent state, while Xenesis only reports local credential and environment status with no OAuth, browser launch, or network login.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/usageCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference Logout signs out from the Anthropic account UI flow, while Xenesis clears only local Xenesis auth state and leaves environment variables, profiles, configs, and unrelated files untouched.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/usageCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference RateLimitOptions is an interactive menu driven by subscription and rate-limit state, while Xenesis prints local retry, fallback-provider, max-turn, and context-compaction policy without querying live provider rate-limit state.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/usageCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference config opens the interactive Settings UI with the Config tab; Xenesis exposes a non-interactive local effective-config inspector with redaction and no provider probes, so this is a bounded CLI utility rather than source-equivalent parity.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference env is a hidden disabled stub; Xenesis exposes a visible local runtime environment/config diagnostic with sensitive values redacted and no network or provider checks.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference effort persists low/medium/high/max/auto in app/user settings and warns on env overrides; Xenesis persists local CLI effort state and reports env override precedence, but does not claim full reference app-state/update side effects.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/config/loadConfig.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference plan is a local JSX command that enables or views plan mode; Xenesis preserves its existing `xenesis plan <prompt>` read-only agent execution path and maps reference parity as bounded local routing metadata without changing plan/work behavior.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference ultraplan launches a remote Claude Code on the web planning session and polls for approval; Xenesis exposes a bounded local advanced-plan scaffold with explicit no-network, no-browser, no-remote-session gaps.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference fast mode can render a picker, prefetch organization state, update settings, and switch models; Xenesis reports bounded local fast execution intent and prompt scaffolding without provider calls, billing state, model switching, or settings mutation.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/modePromptCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference think-back is a feature-gated Year in Review command; Xenesis maps it to a local session/context recall scaffold without generation services, analytics upload, hidden feature gates, or network calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/modePromptCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reference thinkback-play is a hidden animation playback hook after thinkback generation; Xenesis reports a deterministic local playback boundary and does not record, replay, animate, open a browser, or start hidden services.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/modePromptCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference init is a prompt command for CLAUDE.md, skills, hooks, and onboarding state, while Xenesis preserves bare init as xenesis.config.json creation and exposes `init claude` setup guidance without file writes, subagents, or onboarding mutation.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference init-verifiers can create verifier skills and suggest/install verification tooling, while Xenesis prints verifier setup guidance without creating .claude skills, configuring MCP, starting servers, or running package managers.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference install runs the native installer, shell integration, and npm cleanup, while Xenesis reports a dry local installer plan and never downloads, installs, modifies PATH, or runs package managers.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference install-github-app drives GitHub Actions/App setup with API key or OAuth token selection, while Xenesis reports local setup boundaries without OAuth, GitHub app install, secrets, workflow writes, or network calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
    referencePath: "E:/agent-anal/src/commands/install-github-app/index.ts; E:/agent-anal/src/commands/install-github-app/ApiKeyStep.tsx"
  },
  {
    id: "reference.cli.command.install_slack_app",
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference install-slack-app can launch Slack app installation, while Xenesis reports setup boundaries without Slack authorization, app installation, browser launches, or network calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference oauth-refresh command is a hidden disabled stub, and Xenesis exposes a visible no-op compatibility route without reading credentials, refreshing tokens, or calling providers.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference onboarding command is a hidden disabled stub, and Xenesis exposes a visible no-op compatibility route without launching onboarding UI, mutating onboarding state, or calling account services.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference passes is a referral/pass UI gated by cached eligibility and reward state, while Xenesis reports pass boundaries without eligibility, billing, subscription, referral, analytics, or provider calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference permissions opens an allow/deny tool permission UI with allowed-tools alias, while Xenesis preserves local permissions list/audit behavior and maps allowed-tools to list without interactive editing.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference privacy-settings views and updates subscriber account privacy settings, while Xenesis reports command boundaries without entitlement checks, account reads or writes, or network calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference sandbox-toggle can open sandbox settings and write excluded command patterns, while Xenesis reports local sandbox-policy guidance and validates exclude input without mutating .claude settings or checking platform sandbox dependencies.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference memory opens a CLAUDE memory-file selector, creates missing Claude memory files, and launches the configured editor, while Xenesis preserves `memory add/list/search` over its local workspace memory store without opening editors, creating CLAUDE.md memory files, or calling network services.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference tasks opens a background tasks UI with bashes alias, while Xenesis preserves durable local agent task start/list/show/run/retry/cancel behavior and maps bashes to list without a TUI.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference upgrade opens an account/subscription upgrade UI gated by subscription state, while Xenesis reports upgrade boundaries without subscription checks, checkout, billing, rate-limit, or provider calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/setupPolicyCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: clear removes local chat context artifacts without deleting session logs, resetting live TUI AppState, executing hooks, or claiming source-equivalent conversation/cache reset behavior.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: color validates the reference color names and persists a local Xenesis session color preference without teammate assignment rules, transcript mutation, or live AppState updates.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: theme persists an allowed local theme setting and lists choices without opening the reference interactive theme picker or previewing syntax highlighting.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: vim toggles or sets a local editor-mode preference and reports the keyboard-binding hint without mutating a live prompt input component.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: keybindings creates or reports a local Xenesis keybindings file with a deterministic template and does not open an editor or claim preview-feature UI parity.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: statusline records local setup intent without spawning the reference statusline setup subagent, editing external settings, or calling providers.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: output-style preserves the reference deprecation intent by directing users to config without implementing obsolete output-style UI state.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: exit and quit return a deterministic non-interactive goodbye without tmux detach, random message selection, worktree exit flow, or graceful TUI shutdown side effects.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/preferenceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: bridge reports Remote Control bridge diagnostics, setup intent, and prompt scaffolding without policy checks, token reads, environment registration, polling, ingress WebSockets, or live bridge AppState mutation.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: bridge-kick renders bridge recovery fault-injection scenarios as dry-run diagnostics without requiring or mutating a live bridge debug handle.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: chrome reports browser integration setup intent without launching Chrome, probing extensions, opening permission URLs, writing browser config, or connecting a browser MCP server.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: desktop reports desktop handoff setup intent without opening a desktop app, IPC channel, handoff component, or OS automation flow.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: mobile and its ios/android aliases report mobile handoff setup intent without QR generation, app-store links, device pairing, or push flows.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: teleport preserves the inspected hidden disabled reference surface as local diagnostic intent only, without creating tunnels, remote sessions, remote shells, or hidden behavior.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: remote-env reports remote environment setup intent without subscription or policy checks and without reading or writing remote environment defaults.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: remote-setup reports setup intent and prompt scaffolding without reading GitHub tokens, preparing OAuth credentials, fetching environments, creating cloud defaults, or calling provider APIs.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: terminal-setup reports terminal setup intent without editing terminal profiles, shell rc files, keybinding files, or OS terminal settings.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: ide reports integration setup intent without detecting IDE processes, installing extensions, opening projects, connecting IDE MCP, or mutating dynamic MCP config.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: voice reports voice-mode setup intent without microphone access, audio streaming, voice service calls, or feature-gate checks.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/remoteBridgeCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Local version command and --version flag print deterministic package name and version without loading provider-backed runtime paths.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: files lists configured workspace filesystem files with safe relative paths. It does not implement reference readFileState/context-cache listing semantics.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/cli/workspaceCommands.test.ts",
        "tests/evaluation/cliWorkspaceParity.test.ts"
      ]
    }
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: diff reports local git diff summary/no-diff/no-git status. It does not implement the reference interactive DiffDialog over context/session messages.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/workspaceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: branch reports local git HEAD state. It does not implement the reference conversation branch/fork UI behavior.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/workspaceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded local utility: add-dir validates an existing local directory and reports validation-only non-persistent scope. It does not update session permission context or persist additional directories like the reference command.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/workspaceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Commit command constructs a reference-like agent prompt from local git status, diff HEAD, branch, recent commits, Git Safety Protocol, allowed Bash rules, and single-commit task instructions; --print exposes the prompt without provider calls or commits for tests.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/workspaceCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference security-review is a prompt command/plugin handoff with command-scoped tools and shell-expanded git context, while Xenesis builds a local security-review prompt from git diagnostics with no plugin marketplace, provider, or remote calls during prompt build.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference perf-issue is a hidden disabled stub, while Xenesis exposes a local performance diagnostic prompt builder from user details and git diagnostics without provider or remote calls during prompt build.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference bughunter is a hidden disabled stub, while Xenesis exposes a local bug-hunt prompt builder over changed code and nearby context without remote fleet execution.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference autofix-pr is a hidden disabled stub, while Xenesis builds a local PR-feedback remediation prompt that uses only user-supplied feedback and local git context.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference issue is a hidden disabled stub, while Xenesis builds a local issue-triage prompt from supplied issue text and workspace diagnostics without querying an issue tracker.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference pr-comments instructs gh/GitHub API calls to fetch PR and review comments, while Xenesis formats or acts on user-supplied comments only and explicitly avoids gh or GitHub API calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference commit-push-pr can commit, push, create/edit PRs, and add reviewers through gh, while Xenesis drafts commit readiness and PR text from local git diagnostics without pushing, creating PRs, or querying GitHub.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference advisor validates model support and updates app/user settings, while Xenesis stores a local advisor model preference under XENESIS_HOME without remote validation or provider probing.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference agents opens an interactive JSX AgentsMenu over runtime tools, while Xenesis prints configured local subagent definitions and does not open an interactive UI.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/cli/reviewCommands.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Bounded session command entrypoint and compatibility alias route to local JSONL session list/show/compact/rewind/resume operations without remote session UI or live provider calls.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Resume command alias reconstructs prior session messages from JSONL and appends the new prompt through the configured mock-safe provider path.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/sessions/history.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Compact command alias produces a deterministic local session summary from recorded events instead of invoking model-backed compaction.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/sessions/history.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Rewind command alias returns a bounded prefix of local session events, preserving current sessions rewind behavior while requiring --events on the top-level alias.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/sessions/history.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: reference brief toggles in-memory brief-only UI/tool state behind entitlement gates, while Xenesis persists local CLI brief state without account entitlement checks, provider calls, or live tool visibility side effects.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: reference copy targets recent assistant UI messages, clipboard OSC 52, temp-file fallback, and an interactive code-block picker; Xenesis writes the selected local session assistant response to $XENESIS_HOME/copy/response.md with no clipboard or picker.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/contentCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: reference export renders the active conversation and may open an interactive export dialog, while Xenesis exports a local JSONL session transcript to a workspace or $XENESIS_HOME text file without UI.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/contentCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference share command is a hidden disabled stub and no remote sharing API is implemented; Xenesis saves a local-share artifact and explicitly reports remote=false.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference summary command is a hidden disabled stub and no provider summarizer is implemented; Xenesis prints a deterministic local session-event summary.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: reference rename generation calls a provider-backed Haiku JSON prompt, while Xenesis stores a provided name or deterministic local kebab-case name in session metadata without provider calls.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/contentCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: reference tag toggles a searchable tag on the active session with React confirmation when removing; Xenesis toggles tags in local session metadata non-interactively.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/contentCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: reference context estimates model-visible token usage after compact/project transforms; Xenesis builds, shows, and searches a saved local workspace context index without provider token accounting.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference ctx_viz command is a hidden disabled stub; Xenesis exposes a deterministic text visualization of the saved local workspace context index.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference btw launches a React side-question UI and model fork, while Xenesis prints deterministic local guidance without TUI, provider calls, cache-safe prompt rebuilding, or network access.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference createMovedToPluginCommand is a prompt helper that can tell users to install marketplace plugins, while Xenesis exposes deterministic moved-to-plugin guidance without marketplace lookup, plugin install, browser launch, or network access.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/miscCompatibilityCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference feedback renders an interactive Feedback component that can submit feedback, while Xenesis saves a local draft or prints draft guidance without upload, browser launch, analytics, remote account calls, or TUI.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/miscCompatibilityCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference stickers loads a local sticker-ordering UI, while Xenesis prints local catalogue guidance without external assets, ordering, browser launch, provider calls, or network access.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/miscCompatibilityCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference ant-trace command is a hidden disabled stub; Xenesis scans local trace ids in session logs and run reports without Anthropic-internal tooling, provider calls, or network access.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference backfill-sessions command is a hidden disabled stub; Xenesis prints a dry-run local session/report backfill summary without writing session data or calling providers.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference break-cache command is a hidden disabled stub; Xenesis clears only $XENESIS_HOME/cache after resolving and verifying the target stays inside XENESIS_HOME.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference debug-tool-call command is a hidden disabled stub; Xenesis performs a dry-run local built-in tool metadata lookup without invoking tools, providers, or MCP servers.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and intentionally safer than the source side effect: reference heapdump calls performHeapDump, while Xenesis writes process memory metadata only and never dumps a real heap.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference insights can parse Claude sessions, call models, collect remote homespaces, and upload reports; Xenesis writes a local JSON summary from XENESIS_HOME only with no model, upload, browser, or network behavior.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference mock-limits command is a hidden disabled stub; Xenesis writes deterministic local mock limit state under $XENESIS_HOME/diagnostics without touching provider quota.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference reset-limits command is a hidden disabled stub; Xenesis removes only local mock limit state under $XENESIS_HOME/diagnostics and never resets provider account limits.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference extra-usage can inspect billing access, create admin requests, invalidate overage caches, and open browser settings; Xenesis prints local status with no billing API, admin request, browser, or network behavior.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility: the inspected reference good-claude command is a hidden disabled stub; Xenesis exposes a deterministic local compatibility no-op with no provider calls, state mutation, or network access.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Mapped only as a bounded Xenesis local utility and not source-equivalent: reference release-notes loads a local command implementation; Xenesis prints deterministic package release metadata without network lookup or remote update checks.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/cli/diagnosticCommands.ts; src/cli/main.ts; src/cli/help.ts",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Plugin command surface aliases singular `plugin` to the existing local plugin lifecycle. Marketplace discovery/install network behavior is not claimed in this bounded slice.",
    status: "mapped",
    parityStatus: "parity_ready",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/cli/extensionCommands.test.ts",
        "tests/evaluation/cliExtensionParity.test.ts"
      ]
    }
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Skills command surface aliases singular `skill` to configured local SKILL.md listing/showing without remote skill discovery.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "MCP command surface exposes local config inspection for configured servers and does not connect, authenticate, or probe by default.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "cli",
    source: "reference-required",
    observable: "Reload-plugins command surface aliases to local plugin reload diagnostics over enabled/configured plugin manifests. Remote settings sync refresh is not claimed in this slice.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/cli/main.ts; src/cli/help.ts; src/extensions/plugins.ts",
  ...
  },
  {
    ...
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/core/input/InputNormalizer.ts; src/cli/main.ts; src/cli/slashCommands.ts; src/core/AgentRunPipeline.ts",
  ...
  },
  {
    ...
    category: "input",
    source: "reference-required",
    observable: "Reference processUserInput bash-mode command wrapping, attachment ordering, no-query routing, and stdout/stderr XML conversion.",
    status: "mapped",
    parityStatus: "parity_ready",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/core/inputNormalizer.test.ts",
        "tests/evaluation/inputProcessUserInputParity.test.ts"
      ]
    }
  },
  {
    ...
    category: "config",
    source: "reference-required",
    observable: "Config defaults, project file, active profile, environment, CLI precedence, read-only snapshots, permissions, and validation failures.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "provider",
    source: "reference-required",
    observable: "Provider request projection, immutable query config, model/provider identity, tool catalog exposure, tool-result wrapping, and usage accounting.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "plugin",
    source: "reference-required",
    observable: "Built-in plugin registry IDs, availability gating, settings-based enablement, manifest projection, and bundled skill command projection including visibility, hooks, isEnabled, skillRoot, context, and agent metadata.",
    status: "mapped",
    parityStatus: "parity_ready",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/extensions/extensions.test.ts",
        "tests/evaluation/pluginRuntimeParity.test.ts"
      ]
    }
  },
  {
    ...
    category: "plugin",
    source: "reference-required",
    observable: "Bundled skill command metadata, visibility flags, disable-model-invocation behavior, file-backed lazy extraction with safe paths and base-directory prompting, and /batch guard/prompt contract.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/extensions/skills.ts; src/extensions/types.ts",
    referencePath: "E:/agent-anal/src/skills/bundled/batch.ts; E:/agent-anal/src/skills/bundledSkills.ts; E:/agent-anal/src/skills/loadSkillsDir.ts",
    parityEvidence: {
      ...
      tests: [
        "tests/extensions/extensions.test.ts",
        "tests/evaluation/pluginSkillsParity.test.ts"
      ]
    }
  },
  {
    ...
    category: "replay",
    source: "reference-required",
    observable: "Session JSONL serialization, resume message reconstruction, compact summaries, rewind, latest state lookup, and remote session history pagination.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "sdk",
    source: "reference-required",
    observable: "Headless and embedded SDK entrypoint option forwarding, structured result shape, event forwarding, output serialization, workflow mode override, and failure surface.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "replay",
    source: "reference-required",
    observable: "Repair orphan tool results, duplicate tool_use IDs, missing tool results, and synthetic repair results.",
    status: "mapped",
    parityStatus: "parity_ready",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/core/toolResultPairing.test.ts",
        "tests/evaluation/replayCorruptRepairParity.test.ts"
      ]
    }
  },
  {
    ...
    category: "replay",
    source: "reference-required",
    observable: "Legacy channel session JSON migration from string and object map values into durable SQLite channel session rows, invalid entry filtering, and migrated-file marking.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/db/startupImports.ts; src/channels/SqliteChannelSessionStore.ts; src/evaluation/replay/LegacySessionMigrationReplay.ts",
    referencePath: "E:/agent-anal/src/assistant/sessionHistory.ts",
    parityEvidence: {
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference PowerShell constrains .NET type literals through a normalized CLM allowlist that excludes network-binding ADSI/WMI/CIM session accelerators; Xenesis maps this to the existing local shell tool and Windows safety policy without claiming full reference CLM analyzer parity.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/shellTool.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference Config exposes get/set setting operations with read auto-allow, write approval, supported-key validation, boolean coercion, option checks, app-state sync, and local config persistence; Xenesis maps this to its existing local config tool without provider or feature-gated voice side effects.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference FileEdit identifies the Edit tool, Claude folder permission patterns, and the stale-file error string requiring a fresh read before editing; Xenesis maps this to the existing edit behavior without claiming the full reference edit implementation.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/fileTools.ts",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Fresh full read-state authorizes exact file edits, while stale or partial read-state failures prevent mutation; this does not claim full reference FileEdit implementation, Claude folder permission pattern, or UI hook parity.",
    status: "mapped",
    parityStatus: "parity_ready",
    mappedTo: "src/tools/fileTools.ts",
    referencePath: "E:/agent-anal/src/tools/FileEditTool/constants.ts",
    parityEvidence: {
      ...
      tests: [
        "tests/tools/fileTools.test.ts",
        "tests/evaluation/toolFileEditOracleParity.test.ts"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference NotebookEdit identifies the NotebookEdit tool surface for notebook cell mutation; Xenesis maps this to the existing notebook edit tool without claiming source-equivalent notebook implementation details.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    observable: "Xenesis CronCreate, CronList, CronDelete, session-only versus durable storage, deterministic spreading, off-minute scheduling guidance, and recurring auto-expiry.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference sleep surface is intentionally upgraded to the Xenesis wait primitive: provider-visible name/input are `wait` and `waitMs`, while legacy `sleep` and `durationMs` remain compatibility-only registry aliases.",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference-style synthetic output pseudo-tool is intentionally excluded. Xenesis should model structured artifact results through Agent/CR artifact capabilities instead of keeping a dormant provider-visible legacy structured-output tool.",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "AskUserQuestion multiple-choice questions, answer annotations, interaction metadata, permission ask behavior, and model-visible result block mapping.",
    status: "mapped",
    parityStatus: "parity_ready",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/evaluation/askUserQuestionParity.test.ts",
        "tests/tools/toolSearchTool.test.ts"
      ]
    }
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "ToolSearch prompt guidance, deferred-tool selection, keyword search, MCP prefix search, pending MCP diagnostics, and model-visible JSONSchema function block.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Xenesis user_message tool identity, legacy message aliases, attachment validation and resolution, image detection, delivery timestamp, and model-visible result block mapping.",
    status: "mapped",
    parityStatus: "parity_ready",
    ...
    parityEvidence: {
      ...
      tests: [
        "tests/tools/referenceToolParity.test.ts",
        "tests/evaluation/referenceToolsWave1Parity.test.ts"
      ]
    }
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference MCP collapse classifier surface is intentionally excluded. Xenesis MCP behavior stays in the MCP extension/runtime bridge and should not preserve a standalone copied allowlist/classifier tool surface.",
    status: "intentionally_excluded",
    parityStatus: "inventory_only"
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference-style MCP auth pseudo-tool is intentionally excluded from the built-in Agent tool package. MCP auth/connect work should be routed through Xenesis MCP/runtime setup capabilities instead of a provider-shaped pseudo-tool.",
    status: "intentionally_excluded",
    parityStatus: "inventory_only",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference remote trigger provider bridge is intentionally excluded. Xenesis Desk control and remote actions should route through CR/MCP capabilities rather than a separate provider-specific remote trigger tool.",
    status: "intentionally_excluded",
    parityStatus: "inventory_only"
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "REPL tool identity, environment enablement gate, and Xenesis primitive tools hidden from direct model use when REPL mode is active.",
    status: "mapped",
    parityStatus: "parity_ready",
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Reference Skill surface is intentionally upgraded to Xenesis-owned `xenesis_skill` naming/input while preserving local prompt-skill validation, slash-prefix compatibility, prompt expansion, model/tools/effort context propagation, and delegated skill execution.",
    status: "intentionally_upgraded",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/skillTool.ts; src/extensions/skills.ts; src/tools/registry.ts; src/core/AgentRunner.ts; src/core/AgentRunnerBuilder.ts",
  ...
  },
  {
    ...
    category: "mcp",
    source: "reference-required",
    observable: "Mapped only as a bounded local MCP runtime and not source-equivalent: reference runtime includes OAuth discovery, token refresh, credential storage, XAA, prompts, resources, and reconnect behavior; Xenesis covers mock/local MCP tool, resource, prompt, credential-key, token-state, and workflow/tool-search surfaces without starting live MCP servers, OAuth, elicitation, browser, or network flows.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/extensions/mcp.ts; src/core/AgentRuntimeFactory.ts; src/tools/toolSearchTool.ts; src/workflows/builtins.ts",
  ...
  },
  {
    ...
    parityEvidence: {
      ...
      tests: [
        ...
        "tests/evaluation/toolMcpResourcesOracleParity.test.ts"
      ]
    }
  },
  {
  ...
  },
  {
    ...
    category: "tool",
    source: "reference-required",
    observable: "Mapped only as a bounded local WebSearch tool and not source-equivalent: reference WebSearch prompt requires source citation after answers, supports domain filtering guidance, uses current month/year for recent queries, and is US-availability scoped; Xenesis preserves mocked HTML result parsing and link formatting without live search provider, domain filtering, source-section enforcement, or regional availability claims.",
    status: "mapped",
    parityStatus: "mapped_without_oracle",
    mappedTo: "src/tools/webTools.ts; src/tools/registry.ts",
...
function rebaseSingleReferencePath(referencePath: string, referenceRoot: string): string {
  const relativePath = normalizeReferenceRoot(referencePath)
    .replace(referenceSourceRoot, "")
    .replace(/^\/+/, "");
...
export function buildSourceFeatureCatalog(options: SourceFeatureCatalogOptions): SourceFeatureCatalog {
  ...
  const uniqueBuiltInTools = Array.from(
    new Map(Array.from(createBuiltInTools({ env: {} as NodeJS.ProcessEnv }).values()).map((tool) => [tool.name, tool])).values()
  );
  ...
  const referenceInventory = discoverReferenceInventory(referenceRoot)
    .filter((item) => !promotedReferenceIds.has(item.id));
...
export function assertSourceFeaturesParityReady(catalog: SourceFeatureCatalog): void {
  const notReady = catalog.items.filter((item) => (
  ...
  if (notReady.length > 0) {
    throw new Error(`Found ${notReady.length} source features that are not parity-ready: ${notReady.map((item) => item.id).join(", ")}`);
  }
}

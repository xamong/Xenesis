...
const referenceImplementationTargets: Record<string, ReferenceImplementationTarget> = {
  ...
  'reference.cli.command.config': {
    ...
    tests: ['tests/cli/configModelEnvEffortCommands.test.ts', 'tests/evaluation/cliConfigModelEnvEffortParity.test.ts'],
  },
  ...
  'reference.cli.command.plan': {
    ...
    tests: ['tests/cli/modePromptCommands.test.ts', 'tests/evaluation/cliModePromptParity.test.ts'],
  },
  ...
  'reference.cli.command.init': {
    ...
    tests: ['tests/cli/setupPolicyCommands.test.ts', 'tests/evaluation/cliSetupPolicyParity.test.ts'],
  },
  ...
  'reference.cli.command.context': {
    ...
    tests: [
      'tests/cli/contentCommands.test.ts',
      'tests/cli/contextArtifacts.test.ts',
      'tests/evaluation/cliContentParity.test.ts',
    ],
  },
  ...
  'reference.provider.query': {
    ...
    xenesisTarget: ['src/providers/queryConfig.ts', 'src/providers/types.ts', 'src/core/AgentRunner.ts'],
    tests: ['tests/providers/providerQueryConfig.test.ts', 'tests/core/agentRunner.test.ts'],
  },
  'reference.replay.session_messages': {
    xenesisFeatureId: 'replay.session_messages',
    xenesisTarget: ['src/sessions/history.ts', 'src/cli/main.ts', 'src/core/AgentRunner.ts'],
    tests: ['tests/sessions/history.test.ts', 'tests/cli/cli.test.ts', 'tests/core/agentRunner.test.ts'],
  },
  ...
  'reference.sdk.entrypoints': {
    ...
    xenesisTarget: ['src/api/headless.ts', 'src/api/embedded.ts', 'src/core/AgentRunPipeline.ts'],
    tests: ['tests/api/headless.test.ts', 'tests/api/embedded.test.ts', 'tests/core/agentRunEntryPoints.test.ts'],
  },
  ...
  'reference.tool.worktree.lifecycle': {
    ...
    xenesisTarget: [
      ...
      'src/core/isolation/gitWorktree.ts',
    ],
    tests: [

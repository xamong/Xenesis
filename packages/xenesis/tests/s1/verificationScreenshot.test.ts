...
import { type AppE2ECheckOptions, createAppE2ECheckTool } from '../../src/tools/appE2ECheckTool.js';
...
class FakeDriver implements BrowserDriver {
  ...
  async goto(): Promise<BrowserSnapshot> {
  ...
  async fill(): Promise<BrowserSnapshot> {
    return this.browserSnapshot;
  }
  ...
  async boundingBoxes(): Promise<null[]> {
    return [];
  }
  async screenshotWithMarks(): Promise<string> {
    return RAW_B64;
  }

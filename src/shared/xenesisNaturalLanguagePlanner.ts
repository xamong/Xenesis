...
import {
  ...
  deskSettingsCategoryOpenPlanFromNaturalText,
  ...
  xenesisConnectionChannelTestPlanFromNaturalText,
  xenesisConnectionMcpInstallDraftApplyPlanFromNaturalText,
  xenesisConnectionOAuthSetupPacketPlanFromNaturalText,
  xenesisConnectionOpenOrShowPlanFromNaturalText,
  xenesisConnectionProviderProfileDraftApplyPlanFromNaturalText,
  xenesisConnectionReadbackPlanFromNaturalText,
  xenesisConnectionReviewRequestPlanFromNaturalText,
  xenesisConnectionSetupApplyPlanFromNaturalText,
  xenesisConnectionUserStoryWorkflowPreviewPlanFromNaturalText,
...
export function planXenesisDeskNaturalLanguageActions(text: string): XenesisDeskNaturalLanguagePlan {
  ...
  const plan = firstXenesisNaturalLanguagePlan([
    ...
    () => xenesisConnectionProviderProfileDraftApplyPlanFromNaturalText(value),
    ...
    () => xenesisConnectionChannelTestPlanFromNaturalText(value),
    () => xenesisConnectionSetupApplyPlanFromNaturalText(value),
    () => xenesisConnectionOAuthSetupPacketPlanFromNaturalText(value),
    () => xenesisConnectionUserStoryWorkflowPreviewPlanFromNaturalText(value),
    ...
    () => deskSettingsCategoryOpenPlanFromNaturalText(value, placement),

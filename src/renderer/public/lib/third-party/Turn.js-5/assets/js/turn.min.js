...
!function(a) {
    ...
    b.transitionEnd = function(a, b) {
        var c, d, e = document.createElement("fakeelement"), f = {
    ...
    b.trigger = function(c, d, e) {
        var f = a.Event(c);
        return d.trigger(f, e),
        f.isDefaultPrevented() ? b.EVENT_PREVENTED : f.isPropagationStopped() ? b.EVENT_STOPPED : ""
    }
    ,
    b.error = function(a) {
        function b(a) {
        ...
        return TurnJsError.prototype = new Error,
    ...
    b.setListeners = function(a, b, c) {
        if (c)
            for (var d = 0; d < c.length; d++)
                a.on(b, c[d].selector, c[d].handler)
    }
    ,
    ...
    b.widgetInterface = function(c, d, e) {
        var f = a.data(this, d);
        return f ? f._bind.apply(f, e) : (b.oneTimeInit(),
        f = new c(this,d),
        a.data(this, d, f),
        f._init.apply(f, e))
    }
    ...
    b.oneTimeInit = function() {
        this.vendor || (this.has3d = this.css3dAvailable(),
    ...
    b.calculateBounds = function(a) {
        ...
        if (b.width > a.boundWidth || b.height > a.boundHeight) {
            ...
            a.boundWidth / c > a.boundHeight && a.boundHeight * c <= a.boundWidth ? (b.width = Math.round(a.boundHeight * c),
            b.height = a.boundHeight) : (b.width = a.boundWidth,
    ...
    b.animate = function(b, c) {
        if (!c)
            return b.animation && b.animation.stop(),
            void 0;
        if (b.animation) {
            ...
            c.to.length || (c.to = [c.to]),
            c.from.length || (c.from = [c.from]);
            var e = !0;
            b.animation = a.extend({
                ...
                _frame: function() {
                    for (var a = Math.min(this.duration, (new Date).getTime() - this._time), c = 0; c < this._elements; c++)
                        this.current[c] = this.easing(a, this.from[c], this.to[c], this.duration);
                    e = !0,
                    this.frame(this.current),
                    a >= this.duration ? (this.stop(),
                    this.completed && this.completed()) : window.requestAnimationFrame(function() {
    ...
    b.addDelegateList = function(a, c) {
        if (a)
            for (var d in a)
                b.has(d, a) && c.on(d, a[d])
    }
    ,
    b.getDeviceName = function() {
        var a = ""
          , b = navigator.userAgent;
        return /ipad/i.test(b) ? a = "ipad" : /iphone/i.test(b) ? a = "iphone" : /ipod/i.test(b) ? a = "ipod" : /kindle/i.test("iPod") && (a = "kindle"),
        a
    }
    ,
    ...
    a.fn.transform = function(a, c) {
        var d = {};
        return c && (d[b.vendor + "transform-origin"] = c),
        ...
        a.event.special[c] = {
            ...
            remove: function(b) {
                var d = b.selector || ""
                  ...
                  , f = a(this)
                  , g = f.data(e);
                g && g.listeners > 0 && (g.listeners--,
                0 === g.listeners && (g.instance._remove(),
                delete g.instance))
            }
        }
    }
    ...
    var d = b.Event("tap", {
        _init: function() {
            c ? (this.$el.on("touchstart", this._selector, a.proxy(this, "_touchstart")),
            this.$el.on("touchmove", this._selector, a.proxy(this, "_touchmove")),
            this.$el.on("touchend", this._selector, a.proxy(this, "_touchend"))) : this.$el.on("click", this._selector, a.proxy(this, "_trigger"))
        },
        _remove: function() {
            c ? (this.$el.off("touchstart", this._selector, this._touchstart),
            this.$el.off("touchmove", this._selector, this._touchmove),
            this.$el.off("touchend", this._selector, this._touchend)) : this.$el.off("click", this._selector, this._trigger)
        },
    ...
    var m = {
      ...
      , n = b.UIComponent(function(d) {
        ...
        if (d.cornerPosition = b.point2D(parseInt(h[0], 10), parseInt(h[1], 10)),
        e.options = d,
        e.dynamicMode = !1,
        e.turningPage = !1,
        e.watchSizeChange = !0,
        ...
        d.delegate)
            for (var i in d.delegate)
                b.has(i, d.delegate) && ("tap" == i || "doubletap" == i ? this.$el.on(i, ".page", d.delegate[i]) : this.$el.on(i, d.delegate[i]));
        this.$el.css({
            position: "relative",
            width: d.width,
            height: d.height
        }),
        c ? this.$el.addClass("touch-device") : this.$el.addClass("no-touch-device"),
        this.display(d.display),
        "" !== d.direction && this.direction(d.direction);
        for (var j = 0; j < f.length; j++)
            a(f[j]).is(d.ignoreElements) || this.addPage(f[j], ++g);
        return d.pages = e.totalPages,
        e.dynamicMode = 0 === g,
        ...
        d.animatedAutoCenter && this.$el.css(b.addCssWithPrefix({
    ...
    q.prototype._cornerAllowed = function() {
        ...
        case "sheet":
            if (d.display == b.DISPLAY_SINGLE)
                return 1 == c ? b.corners.forward : c == d.totalPages ? b.corners.backward : "tapping" == a.status ? b.corners.all : b.corners.forward;
            if (d.display == b.DISPLAY_DOUBLE)
                return d.options.showDoublePage ? b.corners[e ? "backward" : "forward"] : b.corners[e ? "forward" : "backward"]
        }
    }
    ,
    q.prototype._cornerActivated = function(c) {
        ...
        if (g.dpoint) {
            ...
            if (i = Math.max(i.x, i.y),
            j.x <= i && j.y <= i)
                return f.corner = g.dpoint.corner,
                f
        }
    ...
    q.prototype._foldingPage = function(a) {
        ...
        if (c) {
            var d = c.turnData;
            return a = a || "pageObjs",
            d.display == b.DISPLAY_SINGLE ? d[a][0] : c.over ? d[a][c.over] : d[a][c.next]
        }
        return !1
    }
    ,
    ...
    q.prototype._addPageWrapper = function() {
        var c = this.$el.data("f");
        c.turnData;
        var d, e = this.$el.parent(), f = a("<div />", {
            "class": "inner-page"
        }), g = a("<div />", {
    ...
    q.prototype._fold = function(a) {
        var c = this.$el.data("f");
        if (c.dpoint && c.dpoint.corner == a.corner && c.dpoint.x == a.x && c.dpoint.y == a.y)
            return !1;
        switch (c.effect) {
        case "hard":
            this._hard(a);
        ...
        return c.dpoint = b.peelingPoint(a.corner, a.x, a.y),
        !0
    }
    ,
    q.prototype._bringClipToFront = function(a) {
        ...
        if (c) {
            ...
            if (a) {
                var f = e ? 0 : c.next;
                if (c.over && c.over != f && this._bringClipToFront(!1),
                "hard" == c.effect)
                    c.igradient.show();
    ...
    q.prototype._restoreClip = function(a, c) {
        var d, e = this.$el.data("f"), f = e.turnData, g = a ? b.translate(0, 0, f.options.acceleration) : "";
        c ? d = e : f.pages[e.over] && (d = f.pages[e.over].data("f")),
        d && (d.clip && d.clip.transform(g),
    ...
    q.prototype._showFoldedPage = function(a, c) {
        ...
        if (d && e) {
            ...
            if (!f || !d.point || d.point.corner != a.corner) {
                if (i.corner = g,
                this._trigger("start", d.page, i.tpage ? null : a.corner) == b.EVENT_PREVENTED)
                    return !1;
            ...
            return this._setFoldedPagePosition(a, c),
            !0
        }
        return !1
    }
    ...
    q.prototype.hide = function() {
        ...
        return a.visible && 0 === c.front.length && n.prototype._removeFromDOM.call(a.turn),
        a.status = "",
        a.visible = !1,
        delete a.point,
        delete a.dpoint,
    ...
    q.prototype.turnPage = function(c) {
        var d, e, f = this.$el, g = f.data("f"), h = g.turnData, i = [0, 0, 0, 0];
        if (has3d = b.css3dAvailable(),
        ...
        f.flip("_animate", !1),
        f.flip("_showFoldedPage", i[0]) ? (g.turnData.options.autoCenter && n.prototype.center.call(g.turn, g.next),
        f.flip("_animate", {
            from: 0,
            to: 1,
    ...
    q.prototype._showWhenHolding = function() {
        var c, d = this.$el, e = d.data("f"), f = e.turn, g = e.turnData;
        if (e.holdingPoint) {
            var h = g.display == b.DISPLAY_SINGLE
              , i = this._cornerAllowed();
            if (c = g.direction == b.DIRECTION_LTR ? h ? e.holdingPoint.x > d.width() / 2 ? "r" : "l" : g.options.showDoublePage ? 0 === e.page % 2 ? "r" : "l" : 0 === e.page % 2 ? "l" : "r" : h ? e.holdingPoint.x > d.width() / 2 ? "l" : "r" : g.options.showDoublePage ? 0 === e.page % 2 ? "l" : "r" : 0 === e.page % 2 ? "r" : "l",
            n.prototype.stop.call(f),
            this._animate(!1),
            e.status = "holding",
            ~a.inArray(c, i)) {
                g.tmpListeners || (g.tmpListeners = {},
                g.tmpListeners.tap = b.getListeners(f.$el, "tap", !0),
                g.tmpListeners.doubleTap = b.getListeners(f.$el, "doubleTap", !0));
    ...
    q.prototype._pagePress = function(c) {
        ...
        if (!d.corner && !d.disabled && !this.isTurning()) {
            ...
            d.corner && this._foldingPage())
                return n.prototype.update.call(e),
                !0;
            d.corner = null;
            ...
            h.x -= i.left,
            h.y -= i.top,
            f.options.smartFlip && ~a.inArray(d.page, n.prototype.view.call(e)) && h.x > 0 && h.y > 0 && h.x < this.$el.width() && h.y < this.$el.height() && (d.holdingPoint = h,
            d.startPoint = h,
            d.holding = setTimeout(a.proxy(this._showWhenHolding, this), 100))
        }
    }
    ,
        ...
        if (!g.disabled) {
            ...
            if (!this.animation)
                if (c = this._isIArea(a)) {
                    if (g.hover) {
                        if ("sheet" == g.effect && 2 != c.corner.length)
                            return !1;
                    ...
                    "peel" == g.status && (g.peel && g.peel.corner == g.dpoint.corner || (g.status = "",
    ...
    q.prototype._pageUnpress = function() {
        ...
        if (!c.disabled && d && "turning" != f.status && "swiped" != f.status) {
            ...
            if (f.display == b.DISPLAY_SINGLE)
                if (1 == h)
                    "tapping" == c.status || g.x < i / 2 ? n.prototype._turnPage.call(e, c.next, g.corner) : this.hideFoldedPage(!0);
                else if (~a.inArray(g.corner, b.corners.forward))
                    "tapping" == c.status || g.x < i / 2 ? n.prototype._turnPage.call(e, c.next, g.corner) : this.hideFoldedPage(!0);
                else {
                    var j = f.pages[c.page - 1];
                    g = j.data("f").point,
                    "tapping" == c.status || g.x > .1 * i ? (n.prototype._turnPage.call(e, c.page - 1, g ? g.corner : null),
                    f.status = "turning") : j.flip("turnPage", g.corner)
                }
            else
                f.display == b.DISPLAY_DOUBLE && ("tapping" == c.status || g.x < 0 || g.x > i ? n.prototype._turnPage.call(e, c.next, g.corner) : this.hideFoldedPage(!0))
        }
        c.holdingPoint && (clearInterval(c.holding),
        delete c.holdingPoint,
        delete c.holding),
        c.status = "",
        c.corner = null
    }
    ...
    q.prototype.disable = function(a) {
        return this.$el.data("f").disabled = a,
        this.$el
    }
    ,
    q.prototype.hover = function(a) {
        return this.$el.data("f").hover = a,
        this.$el
    }
    ,
    ...
    q.prototype._animationCompleted = function(a, c) {
        var d = this.$el.data("f")
          , e = d.turn
          , f = d.turnData;
        if ((c || !d.peel || d.peel.corner != d.dpoint.corner) && (f.front.splice(f.front.indexOf(parseInt(d.next, 10)), 1),
        ...
        c) {
            ...
            g == d.next || g == d.page ? (delete f.tpage,
            n.prototype._fitPage.call(e, g || d.next)) : f.pageWrap[d.page].hide()
        } else
            f.display == b.DISPLAY_SINGLE && a == f.tpage ? (delete f.tpage,
            n.prototype._fitPage.call(e, a)) : (n.prototype.update.call(e),
            n.prototype._updateShadow.call(e));
        this.$el.css({
            visibility: ""
        }),
    ...
    q.prototype._animate = function(b) {
        ...
        if (this._animation) {
            ...
            this.animation = a.extend({
                ...
                _frame: function() {
                    for (var a = Math.min(this.duration, (new Date).getTime() - this._time), b = 0; b < this._elements; b++)
                        this.current[b] = this.easing(a, this.from[b], this.to[b], this.duration);
                    e = !0,
                    this.frame(1 == this._elements ? this.current[0] : this.current),
                    a >= this.duration ? (this.stop(),
                    this.complete && this.complete()) : window.requestAnimationFrame(function() {
    ...
    n.prototype.addPage = function(c, d, e) {
        ...
        if (f.destroying)
            return null;
        var g, h = "", i = !1, j = f.totalPages + 1;
        if (e = e || {},
        (g = /\bpage\-([0-9]+|last|next\-to\-last)\b/.exec(a(c).attr("class"))) && (d = "last" == g[1] ? f.totalPages : "next-to-last" == g[1] ? f.totalPages - 1 : parseInt(g[1], 10)),
        d) {
            if (d == j)
                i = !0;
            else if (d > j)
                throw b.error('Page "' + d + '" cannot be inserted')
        } else
            d = j,
            i = !0;
        return d >= 1 && j >= d && (d in f.pageObjs && this._movePages(d, 1),
        i && (f.totalPages = j),
        f.pageObjs[d] = a(c),
    ...
    n.prototype.effect = function(a, c) {
        ...
        if (d = e.pageObjs[a]) {
            if (void 0 === c)
                return d.hasClass("hard") ? "hard" : "sheet";
            var f = e.dynamicMode;
            switch (e.dynamicMode = !1,
            c) {
            case "hard":
                d.removeClass("sheet"),
                d.addClass("hard"),
            ...
            return e.dynamicMode = f,
            this._pageNeeded(a) && this._addPage(a),
            this.$el
        }
    ...
    n.prototype._pageSize = function(a) {
        ...
        if (c.display == b.DISPLAY_SINGLE)
            ...
            d.left = 0,
            d.right = "auto",
            g.hasClass("page") ? (d.top = c.pageMargin[0],
            d.width -= c.pageMargin[1],
            d.height -= c.pageMargin[0] + c.pageMargin[2]) : 2 == a && g.hasClass("cover") && (d.left = -e);
        else if (c.display == b.DISPLAY_DOUBLE) {
            var h = Math.floor(e / 2)
              , i = f
              , j = a % 2;
            d.top = 0,
            g.hasClass("own-size") ? (d.width = c.pageObjs[a].width(),
            d.height = c.pageObjs[a].height()) : (d.width = h,
            d.height = i),
            g.hasClass("page") && (d.top = c.pageMargin[0],
            d.width -= j ? c.pageMargin[1] : c.pageMargin[3],
            d.height -= c.pageMargin[0] + c.pageMargin[2]),
            c.direction != b.DIRECTION_LTR || c.options.showDoublePage ? (d[j ? "left" : "right"] = h - d.width,
            d[j ? "right" : "left"] = "auto") : (d[j ? "right" : "left"] = h - d.width,
            d[j ? "left" : "right"] = "auto")
        }
        return d
    }
    ...
    n.prototype._makeFlip = function(a) {
        var c = this._data;
        if (!c.pages[a]) {
            var d, e = c.display == b.DISPLAY_SINGLE, f = a % 2;
            d = e ? a + 1 : c.options.showDoublePage && !e ? f ? a - 1 : a + 1 : f ? a + 1 : a - 1,
            c.options.blocks > 0 && (c.pageBlocks[a] || (c.pageBlocks[a] = {
                first: 0,
                last: 0,
    ...
    n.prototype._makeRange = function() {
        var a, b = this._data;
        if (b.totalPages > 0)
            for (b.range = this.range(),
            a = b.range[0]; a <= b.range[1]; a++)
                b.pageObjs[a] && !b.pageWrap[a] && this._addPage(a)
    }
    ,
    n.prototype.range = function(a) {
        var c, d, e, f, g = this._data, h = g.totalPages;
        ...
        return a = a || g.tpage || g.page || 1,
        f = this._view(a),
        f[1] = f[1] || f[0],
        f[0] >= 1 && f[1] <= h ? (c = Math.floor((g.options.cacheSize - 2) / 2),
        h - f[1] > f[0] ? (d = Math.min(f[0] - 1, c),
        e = 2 * c - d) : (e = Math.min(h - f[1], c),
        d = 2 * c - e)) : (d = g.options.cacheSize - 1,
        e = g.options.cacheSize - 1),
    ...
    n.prototype._removeFromDOM = function() {
        if (!this.isAnimating()) {
            ...
            for (var c in a.pageWrap)
                b.has(c, a.pageWrap) && (c = parseInt(c, 10),
    ...
    n.prototype.pageData = function(a, b) {
        var c = this._data;
        return void 0 === b ? c.pageObjs[a].data("f") : (c.pageObjs[a].data("f", b),
        void 0)
    }
    ,
    n.prototype._removePageFromDOM = function(a, c) {
        var d = this._data;
        this.view(a);
        var e, f = d.pageObjs, g = d.pages;
        if (a && this._trigger("removePage", a, f[a]) == b.EVENT_PREVENTED)
            return !1;
        if (d.pages[a] && (d.pages[a].flip("_bringClipToFront", !1),
        d.pages[a].flip("destroy"),
        d.pages[a].detach(),
        delete d.pages[a]),
        f[a] && f[a].detach(),
        d.pageWrap[a] && (d.pageWrap[a].detach(),
        delete d.pageWrap[a]),
        d.dynamicMode || c) {
            if (e = d.pageBlocks[a]) {
                for (var h = e.last || e.first, i = e.first; h >= i; i++)
                    d.blocks[i] && (d.blocks[i].start ? g[d.blocks[i].start] || g[d.blocks[i].end] || delete d.blocks[i] : delete d.blocks[i]);
    ...
    n.prototype.removePage = function(a) {
        ...
        if ("*" == a) {
            ...
            if (c.pageObjs[a] && (this.stop(),
            !this._removePageFromDOM(a, !0)))
                return !1;
            this._movePages(a, -1),
            c.totalPages = c.totalPages - 1,
            c.page > c.totalPages ? (c.page = null,
            this._fitPage(c.totalPages)) : (this._makeRange(),
            this.update())
        }
        return this
    }
    ...
    n.prototype._movePages = function(a, c) {
        var d, e = this, f = this._data, g = f.display == b.DISPLAY_SINGLE, h = function(a) {
            var b = a + c
              , d = b % 2
              , h = d ? " page-odd " : " page-even ";
            f.pageObjs[a] && (f.pageObjs[b] = f.pageObjs[a].removeClass("page-" + a + " page-odd page-even").addClass("page-" + b + h)),
            f.pageWrap[a] && (f.pageWrap[b] = f.pageObjs[b].hasClass("fixed") ? f.pageWrap[a].attr("page", b) : f.pageWrap[a].css(e._pageSize(b, !0)).attr("page", b),
            f.pages[a] && (f.pages[b] = f.pages[a],
            f.pages[b].data("f").page = b,
            f.pages[b].data("f").next = g ? b + 1 : f.options.showDoublePage ? d ? b - 1 : b + 1 : d ? b + 1 : b - 1),
            c && (delete f.pages[a],
            delete f.pageObjs[a],
            delete f.pageWrap[a]))
        };
        if (c > 0)
            for (d = f.totalPages; d >= a; d--)
                h(d);
        else
            for (d = a; d <= f.totalPages; d++)
                h(d)
    }
    ,
    ...
    n.prototype.view = function(a, b) {
        var c = this._data
          , d = this._view(a)
          , e = [];
        return b ? (d[0] > 0 && e.push(d[0]),
        d[1] <= c.totalPages && e.push(d[1])) : (d[0] > 0 ? e.push(d[0]) : e.push(0),
        ...
        if (a) {
            if (a < b.totalPages)
                for (var c = b.totalPages; c > a; c--)
                    this.removePage(c);
            return b.totalPages = a,
            this._fitPage(b.page),
            this.$el
        }
        return b.totalPages
    }
    ...
    n.prototype._missing = function(a) {
        var b = this._data;
        if (b.totalPages < 1)
            return b.options.blocks > 0 && this.$el.trigger("missing", [1]),
            void 0;
    ...
    n.prototype._backPage = function(b) {
        ...
        if (b) {
            ...
            c.pageObjs[0] && this._removePageFromDOM(0, !0)
    }
    ,
    ...
    n.prototype.getBlockPage = function(a) {
        var c = this._data;
        if (1 > a || a > c.options.blocks)
            return 0;
        if (1 == a)
            return c.options.pages + 1;
    ...
    n.prototype.getPageBlock = function(a, c) {
        ...
        if (d.options.blocks) {
            ...
            if (a == d.options.pages + 1)
                return 1;
            if (a > d.options.pages) {
                if (c) {
                    for (var e, f = this.range(), g = this.view(d.page, !0), h = 0, i = 0, j = 0, k = 0, l = 0, m = f[0]; m <= f[1]; m++)
                        d.pageBlocks[m] && (h || (h = d.pageBlocks[m].first,
                        j = m),
                        d.pageBlocks[m].last && (i = d.pageBlocks[m].last,
                        k = m),
                        d.pageBlocks[m].first && (l = m));
                    0 === i && l && (i = d.pageBlocks[l].first,
                    k = l),
                    d.display == b.DISPLAY_DOUBLE ? d.options.showDoublePage ? 1 === a % 2 && (a > g[g.length - 1] ? (0 === k % 2 && (k -= 1),
                    e = i + (a - k) / 2) : a < g[0] ? (0 === j % 2 && (j -= 1),
                    e = h - (j - a) / 2) : e = (a + 1) / 2) : 0 === a % 2 && (a > f[1] ? (1 == k % 2 && (k -= 1),
                    e = i + (a - k + 2) / 2) : a < f[0] ? (1 == j % 2 && (j -= 1),
                    e = h - (j - a + 2) / 2) : e = (a + 2) / 2) : e = a > f[1] ? d.pageBlocks[f[1]].last + (a - f[1]) : a < f[0] ? d.pageBlocks[f[0]].first - (f[0] - a) : a - d.options.pages
                } else
    ...
    n.prototype.block = function(a) {
        ...
        var i = this.getBlockPage(a)
          , j = this.range();
        return this._cleanPages(j[0], j[1]),
        c.pageBlocks[i] = {
            first: a,
            last: 0,
    ...
    n.prototype._fetchBlocks = function(a) {
        ...
        if (c.options.blocks && c.pageBlocks[a]) {
            ...
            if (d.status == b.fragStatus.assigned)
                ...
                if (a > e[0] && (this._cleanPages(a + 1, this.range()[1]),
                d.nextPageTmp)) {
                ...
                d.status == b.fragStatus.full && e[0] == a && e[1] && this._fetchBlocks(e[1])
        }
    }
    ,
    n.prototype._pushBlocks = function(a, b, c) {
        ...
        if (a > 0 && a <= f.options.blocks)
            if ((e = f.pageBlocks[b]) && (e.waiting = a),
            d = f.blocks[a]) {
                if (b && -1 == d.queue.indexOf(b) && d.queue.push(b),
                c && (d.cp = c),
                d.html) {
    ...
    n.prototype.addBlock = function(a, b) {
        var c = this._data;
        a > 0 && a <= c.options.blocks && (b = b.replace(/\s+/g, " "),
        c.blocks[a] ? (c.blocks[a].html = b,
        this._pushBlocks(a)) : c.blocks[a] = {
            html: b,
            queue: []
        })
    }
    ...
    n.prototype._flowContent = function(c, d) {
        ...
        if (f && g) {
            ...
            if (d < h.first || d > h.last) {
                if (!g.is(":visible"))
                    return h.status = b.fragStatus.assigned,
                    void 0;
                var o = a("<div />", {
                    "class": "block block-" + d,
                    css: {
                ...
                d < h.first) {
                    h.first = d;
                    var p = j.children();
                    p.length > 0 ? (h.bp = null,
                    o.insertBefore(p[0]),
                    this._cleanPages(n[0], c - 1)) : o.appendTo(j)
                } else
                    o.appendTo(j);
                d > h.last && (h.last = d),
                h.waiting == d && (h.waiting = 0)
            } else if (!g.is(":visible"))
                return h.status = b.fragStatus.waiting,
                void 0;
            var q, r, s = c + 1, t = e.pageBlocks[s], u = e.pageObjs[s];
            u && (q = u.data("f"),
            r = q.flowTo ? u.find(q.flowTo) : u,
            t.first == h.last && s < l[0] && (restore(j[0], r[0]),
            q.first = 0,
            q.last = 0,
            q.status = b.fragStatus.assigned));
            var v = getBreakingPoint(j[0]);
            if (v)
                if (h.loading && (h.loading = !1,
                this.$el.trigger("endPageLoading", c)),
                s < l[0] || c >= l[0])
                    if (h.status = b.fragStatus.full,
                    u) {
                        ...
                        for (var w = t.first; w <= t.last; w++)
                            e.blocks[w] && (w == t.first && w == h.last ? e.blocks[w].end = s : (e.blocks[w].start = s,
                            e.blocks[w].end = s));
                        t.bp = v,
                        this._flowContent(s, t.last)
                    } else
                        breakPage(v, j[0], null);
                else
    ...
    n.prototype._reportLoading = function(a) {
        for (var b = this._data, c = this.view(a, !0), d = 0; d < c.length; d++)
            c[d] >= a && !b.pageBlocks[c[d]].loading && (b.pageBlocks[c[d]].loading = !0,
        ...
        for (var c, d, e, f = this._data, g = a; b >= g; g++)
            if ((d = f.pageBlocks[g]) && d.first) {
                ...
                for (var h = d.first; e >= h; h++)
                    f.blocks[h] && (h == d.first && f.pageBlocks[g - 1] && h == f.pageBlocks[g - 1].last || (f.blocks[h].page = 0,
                    f.blocks[h].start && (f.blocks[h].start = 0,
                    f.blocks[h].end = 0)));
                d.first = 0,
    ...
    n.prototype.flow = function() {
        ...
        if (b.options.blocks && this.$el.is(":visible")) {
            ...
            if (d[0] > b.options.pages)
                c = d[0];
            else {
                if (!(d[1] > b.options.pages))
                    return;
                c = d[1]
            }
            var e = this.range()
              ...
              , k = b.blocks[j];
            if (k) {
                if (i.children("div:last-child").html(b.blocks[j].html),
                j == g.first && g.bp) {
                    var l = a.extend({}, g.bp);
                    l.path[0] = 0,
                    breakPage(l, i[0], i[0])
    ...
    n.prototype._fitPage = function(c) {
        ...
        d.range = this.range(c),
        this._missing(),
        d.pageObjs[c] && (-1 != a.inArray(1, e) ? this.$el.addClass("first-page") : this.$el.removeClass("first-page"),
    ...
    n.prototype._turnPage = function(c, d) {
        var e, f, g, h = this._data, i = this.view(), j = this.view(c), k = h.display == b.DISPLAY_SINGLE;
        if (k)
            e = i[0],
            g = j[0];
        else if (i[1] && c > i[1])
        ...
        h.page != c) {
            if (f = h.page,
            this._trigger("turning", c, j, d) == b.EVENT_PREVENTED)
                return ~a.inArray(e, h.pageMv) && h.pages[e].flip("hideFoldedPage", !0),
                !1;
            ~a.inArray(1, j) ? (this.$el.addClass("first-page"),
            this.$el.trigger("first")) : this.$el.removeClass("first-page"),
            ~a.inArray(h.totalPages, j) ? (this.$el.addClass("last-page"),
            this.$el.trigger("last")) : this.$el.removeClass("last-page")
        }
        return h.status = "turning",
        h.range = this.range(c),
        this._missing(c),
        h.pageObjs[c] && (this._cloneView(!1),
        h.tpage = g,
        this._makeRange(),
        ...
        b.hasRotation && !d.disabled && !d.destroying) {
            ...
            !(d.options.blocks > 0 && c == d.totalPages + 1)) {
                if (c > 0 && c <= d.totalPages) {
                    if (c != d.page)
                        if (!d.done || ~a.inArray(c, this.view()))
                            this._fitPage(c);
                        else if (!this._turnPage(c))
                            return !1;
                    return this.$el
                }
                return !1
    ...
    n.prototype.destroy = function() {
        var c = this._data;
        return this._trigger("destroy") != b.EVENT_PREVENTED && (c.watchSizeChange = !1,
        c.destroying = !0,
        this.$el.undelegate(),
    ...
    n.prototype.display = function(a, c) {
        ...
        if (1 == d.zoom) {
            ...
            if (!f)
                throw b.turnError('"' + a + '" is not a value for display');
            if (f != d.display) {
    ...
    n.prototype.disable = function(c) {
        var d, e = this._data, f = this.view();
        e.disabled = void 0 === c || c === !0;
        for (d in e.pages)
            b.has(d, e.pages) && e.pages[d].flip("disable", e.disabled ? !0 : -1 == a.inArray(parseInt(d, 10), f));
        return this.$el
    }
    ,
    n.prototype._size = function(a, b) {
        var c = this._defaultSize();
        return c.width = c.width * a,
        c.height = c.height * a,
    ...
    n.prototype._resizeObserver = function() {
        ...
        if (b && b.watchSizeChange) {
            var c = b.options.viewer
              , d = 10;
            (b.viewerWidth != c.width() || b.viewerHeight != c.height()) && (b.viewerWidth = c.width(),
    ...
    n.prototype.watchForSizeChanges = function(a) {
        var b = this._data;
        b.watchSizeChange != a && (b.watchSizeChange = a,
    ...
    n.prototype._calculateMargin = function() {
        var a, c, d = this._data, e = /^(\d+(?:px|%))(?:\s+(\d+(?:px|%))(?:\s+(\d+(?:px|%))\s+(\d+(?:px|%)))?)$/;
        (a = d.options.margin) ? (c = e.exec(a)) && (d.margin[0] = b.transformUnit(c[1], d.viewerHeight),
        d.margin[1] = c[2] ? b.transformUnit(c[2], d.viewerWidth) : d.margin[0],
        d.margin[2] = c[3] ? b.transformUnit(c[3], d.viewerHeight) : d.margin[0],
        d.margin[3] = c[4] ? b.transformUnit(c[4], d.viewerWidth) : d.margin[1]) : d.margin = [0, 0, 0, 0],
        (a = d.options.pageMargin) ? (c = e.exec(a)) && (d.pageMargin[0] = b.transformUnit(c[1], d.viewerHeight),
        ...
        d.pageMargin[3] = c[4] ? b.transformUnit(c[4], d.viewerWidth) : d.pageMargin[1]) : d.pageMargin = [0, 0, 0, 0]
    }
    ,
    n.prototype._resize = function() {
        ...
        if (e.options.responsive) {
            ...
            if (1 == e.zoom) {
                ...
                this.update(),
                e.zoomer)
                    for (d = this._defaultSize(e.display),
                    e.zoomer.css({
                        width: d.width,
                        height: d.height
                    }),
            ...
            } else if (this.scroll(e.scroll.left, e.scroll.top),
            e.zoomer)
                for (d = this._defaultSize(e.display),
                e.zoomer.css({
                    width: d.width,
        ...
        if (this.isAnimating() && 0 !== c.pageMv[0]) {
            ...
            if (j == b.DISPLAY_SINGLE)
                for (d = 0; h > d; d++)
                    ...
                    g.pageV[nextPage] = !0,
                    c.pageObjs[c.pageMv[d]].hasClass("cover") ? g.pageV[nextPage + 1] = !0 : (g.pageV[0] = !0,
                    g.pageZ[0] = 3 + h + 1);
            else if (c.display == b.DISPLAY_DOUBLE) {
                for (d = 0; h > d; d++) {
                    for (f = a.view(c.pageMv[d]),
                    e = 0; e < f.length; e++)
                        g.pageV[f[e]] = !0;
                    g.pageZ[c.pageMv[d]] = 3 + h - d
                }
                for (d = 0; i > d; d++)
                    for (f = a.view(c.front[d]),
                    g.pageZ[c.front[d]] = 5 + h + d,
                    e = 0; e < f.length; e++)
                        g.pageV[f[e]] = !0
            }
        } else {
            ...
            d = 0; d < f.length; d++)
                g.pageV[f[d]] = !0,
                g.pageZ[f[d]] = 2;
            c.display == b.DISPLAY_SINGLE ? f[0] < c.totalPages && (c.pages[f[0]].hasClass("cover") ? c.pages[f[0] + 1] && !c.pages[f[0] + 1].hasClass("cover") && (g.pageV[f[0] + 1] = !0,
            g.pageZ[f[0] + 1] = 2) : (g.pageV[f[0] + 1] = !0,
            g.pageZ[f[0] + 1] = 1)) : c.display == b.DISPLAY_DOUBLE && (f[0] > 2 && (g.pageV[f[0] - 2] = !0,
            g.pageZ[f[0] - 2] = 1),
            f[1] < c.totalPages - 1 && (g.pageV[f[1] + 2] = !0,
            g.pageZ[f[1] + 2] = 1))
        }
        for (var k in c.pageWrap)
            b.has(k, c.pageWrap) && void 0 === g.pageV[k] && this._isCoverPageVisible(k) && (g.pageV[k] = !0,
            g.pageZ[k] = -1);
        return g
    }
    ,
    n.prototype.update = function() {
        var c, d, e = this._data, f = this.calcVisiblePages();
        if (this.isAnimating() && 0 !== e.pageMv[0]) {
            var g = this.view()
              , h = this.view(e.tpage);
            d = "" === e.status ? e.options.hover : !1;
            for (c in e.pageWrap)
                b.has(c, e.pageWrap) && (e.pageWrap[c].css({
    ...
    n.prototype.options = function(c) {
        ...
        var d = this._data
          , e = d.options.swipe;
        if (a.extend(d.options, c),
        c.pages && this.pages(c.pages),
        c.page && this.page(c.page),
        (c.margin || c.pageMargin) && (this._calculateMargin(),
        this._resize()),
        ...
        if (c.margin && this._resize.call(this),
        c.animatedAutoCenter === !0 ? this.$el.css(b.addCssWithPrefix({
        ...
        c.delegate)
            for (var g in c.delegate)
                b.has(g, c.delegate) && ("tap" == g || "doubletap" == g ? (this.$el.off(g, ".page"),
                this.$el.on(g, ".page", c.delegate[g])) : this.$el.off(g).on(g, c.delegate[g]));
        return this.$el
    }
    ,
    ...
    n.prototype.direction = function(a) {
        ...
        if (!e)
            throw b.turnError('"' + a + '" is not a value for direction');
    ...
    n.prototype.size = function(c, d, e) {
        ...
        var f, g, h, i = this._data, j = this.view();
        if (i.display == b.DISPLAY_DOUBLE ? (c = Math.floor(c),
        d = Math.floor(d),
        1 == c % 2 && (c -= 1),
        h = Math.floor(c / 2)) : h = c,
        this.stop(),
        this.$el.css({
            width: c,
            height: d
        ...
        i.zoom > 1) {
            ...
            for (f in k)
                b.has(f, k) && (g = this._pageSize(f, !0),
                e || i.pageObjs[f].css({
                    width: g.width,
                    height: g.height
                }),
                i.pageWrap[f].css(g),
                i.pages[f] && (i.pages[f].flip("_restoreClip", !1, !0),
                i.pages[f].flip("resize", g.width, g.height)))
        } else
            for (f in i.pageWrap)
                b.has(f, i.pageWrap) && (g = this._pageSize(f, !0),
                e && -1 != a.inArray(parseInt(f, 10), j) || i.pageObjs[f].css({
                    width: g.width,
                    height: g.height
                }),
                i.pageWrap[f].css(g),
                i.pages[f] && (i.pages[f].flip("_restoreClip"),
                i.pages[f].flip("resize", g.width, g.height)));
        ...
        i.pages[0] && (f = i.pages[0].data("f").tPage,
    ...
    n.prototype.stop = function() {
        ...
        if (this.isAnimating()) {
            ...
            for (d.tpage && (d.page = d.tpage,
            delete d.tpage); d.pageMv.length > 0; )
                if (c = d.pages[d.pageMv[0]],
                a = c.data("f")) {
                    var f = a.peel;
                    a.peel = null,
    ...
    n.prototype._eventStart = function(c, d, e) {
        var f = this._data
          , g = a(c.target).data("f");
        return f.display == b.DISPLAY_SINGLE && e && (g.next = "l" == e.charAt(1) && f.direction == b.DIRECTION_LTR || "r" == e.charAt(1) && f.direction == b.DIRECTION_RTL ? g.next < g.page ? g.next : g.page - 1 : g.next > g.page ? g.next : g.page + 1),
        c.isDefaultPrevented() ? (this._updateShadow(),
        void 0) : (this._updateShadow(),
        void 0)
    }
    ,
    n.prototype._eventPress = function(a) {
        ...
        for (var d in c.pages)
            if (b.has(d, c.pages) && c.pages[d].flip("_pagePress", a))
                return c.tmpListeners || (c.tmpListeners = {},
                c.tmpListeners.tap = b.getListeners(this.$el, "tap", !0),
                c.tmpListeners.doubleTap = b.getListeners(this.$el, "doubleTap", !0)),
                a.preventDefault(),
                c.statusHolding = !0,
                void 0;
    ...
    n.prototype._eventMove = function(d) {
        ...
        if (e.finger) {
            ...
            e.tmpListeners || (e.tmpListeners = {},
            e.tmpListeners.tap = b.getListeners(this.$el, "tap", !0),
            e.tmpListeners.doubleTap = b.getListeners(this.$el, "doubleTap", !0)),
            ...
            e.initScroll || (e.initScroll = this.scroll(),
            ...
            var h = b.eventPoint(d)
              ...
              , j = this.scrollSize();
            h.x < e.initCursor.x ? i.x = e.initScroll.left * Math.max(0, (h.x - e.viewerOffset.left - 20) / e.initCursor.x) : h.x > e.initCursor.x && (i.x = e.initScroll.left + (j.width - e.initScroll.left) * Math.min(1, (h.x - e.initCursor.x + 20) / (e.viewerWidth - e.initCursor.x))),
            h.y < e.initCursor.y ? i.y = e.initScroll.top * Math.max(0, (h.y - e.viewerOffset.top - 20) / e.initCursor.y) : h.y > e.initCursor.y && (i.y = e.initScroll.top + (j.height - e.initScroll.top) * Math.min(1, (h.y - e.initCursor.y + 20) / (e.viewerHeight - e.initCursor.y))),
            this.scroll(i.x, i.y)
        }
    }
    ,
    n.prototype._eventRelease = function(a) {
        ...
        if (setTimeout(function() {
            d.tmpListeners && (b.setListeners(c.$el, "tap", d.tmpListeners.tap),
        ...
        d.finger) {
            ...
            delete d.finger,
            delete d.fingerZoom,
            d.statusHolding && (d.statusHolding = !1,
            d.statusHover || this._hasMotionListener(!1)),
            d.zoomed && (this.zoom(d.zoomed[0], d.zoomed[1]),
            delete d.zoomed)
        }
    }
    ,
    n.prototype._eventSwipe = function(c) {
        ...
        if ("turning" != d.status && 1 == d.zoom && d.hasSelection == e)
            if (d.display == b.DISPLAY_SINGLE) {
                var f = d.page;
                if (c.speed < 0) {
                    if (~a.inArray(d.corner, b.corners.forward))
                        this.next();
                    else if (d.status = "swiped",
                    ...
                    c.speed > 0 && (~a.inArray(d.corner, b.corners.backward) ? this.previous() : (d.status = "swiped",
                    d.pages[f].flip("hideFoldedPage", !0)))
            } else
                d.display == b.DISPLAY_DOUBLE && (c.speed < 0 ? this.isAnimating() ? ~a.inArray(d.corner, b.corners.forward) && this.next() : this.next() : c.speed > 0 && (this.isAnimating() ? ~a.inArray(d.corner, b.corners.backward) && this.previous() : this.previous()))
    }
    ,
    ...
    n.prototype._eventNoHover = function(a) {
        ...
        c.noHoverTimer = setTimeout(function() {
            c.statusHolding || (b._eventMove(a),
            b._hasMotionListener(!1)),
    ...
    n.prototype._hasMotionListener = function(b) {
        var c = this._data;
        b ? c.hasMoveListener || (a(document).on("vmousemove", a.proxy(this, "_eventMove")).on("vmouseup", a.proxy(this, "_eventRelease")),
        c.hasMoveListener = !0) : c.hasMoveListener && (a(document).off("vmousemove", this._eventMove).off("vmouseup", this._eventRelease),
        c.hasMoveListener = !1)
    }
    ,
    ...
    n.prototype.scroll = function(a, c) {
        ...
        if (d.zoom > 1 && !d.silentZoom) {
            ...
            this._trigger("scrolling", a, c) != b.EVENT_PREVENTED && (g.x = g.x + f.width / 2 - a,
    ...
    n.prototype._mouseRel = function(a) {
        ...
        if (d.display == b.DISPLAY_DOUBLE) {
            ...
            if (g[0]) {
                if (g[1]) {
                    if (f.x < 0 || f.x > e.width)
                        return null
                } else if (f.x = f.x,
                f.x < 0 || f.x > e.width / 2)
                    return null
            } else if (f.x = f.x - e.width / 2,
            f.x < 0 || f.x > e.width / 2)
                return null
    ...
    n.prototype.zoom = function(c, d) {
        ...
        if ("pageX"in d && "pageY"in d) {
            ...
            if (null === h)
                return this.$el;
            d = a.extend(d, h),
            "factor"in d && (c = d.factor * e.fingerZoom,
            d.animate = !1)
        } else
            "x"in d && "y"in d || (d.x = g ? f.width / 4 : f.width / 2,
            d.y = f.height / 2);
        if (e.silentZoom || this._trigger("willZoom", c, e.zoom) != b.EVENT_PREVENTED) {
            var i, j = this, k = e.zoom;
            e.options.viewer;
            var l = this.view()
            ...
            v = b.point2D(Math.min(u.x, Math.max(0, v.x)), Math.min(u.y, Math.max(0, v.y))),
            g && (n.left += r.width / 2);
            ...
            o) {
                ...
                "factor"in d) {
                    ...
                    this.scroll(v.x, v.y),
                    1 == m ? (this.disable(!1),
                    z && this.peel(z.corner, z.x, z.y, !0)) : e.peel = z,
    ...
    n.prototype._position = function(a) {
        ...
        if (b.options.responsive && (e.top = b.viewerHeight / 2 - d.height / 2,
        e.left = b.viewerWidth / 2 - d.width / 2,
        1 == c)) {
            var f = b.margin;
            (e.top < f[0] || e.top + d.height > b.viewerHeight - f[2]) && (e.top = f[0]),
            (e.left < f[1] || e.left + d.width > b.viewerWidth - f[3]) && (e.left = f[3])
        }
        return e
    }
    ,
    ...
    n.prototype._cloneView = function(c) {
        var d = this._data;
        if (d.zoomer)
            c ? d.zoomer.show() : (d.zoomer.remove(),
            delete d.zoomer);
        else if (c) {
            var e, f, g, h = this.view(), i = {}, j = a("<div />");
            ...
            for (g in i)
                b.has(g, i) && (e = this._pageSize(g, !0),
                e.position = "absolute",
    ...
    q.prototype._pageCURL = function(a) {
        var c, d, e, f, g, h, i, j, k, l, m, n, q, r = this.$el.data("f"), s = r.turnData, t = this.$el.width(), u = this.$el.height(), v = this, w = 0, x = b.point2D(0, 0), y = b.point2D(0, 0), z = b.point2D(0, 0), A = (this._foldingPage(),
        s.options.acceleration), B = r.clip.height(), C = function() {
            c = v._startPoint(a.corner);
            var j, k = t - c.x - a.x, l = c.y - a.y, m = Math.atan2(l, k), n = Math.sqrt(k * k + l * l), q = b.point2D(t - c.x - Math.cos(m) * t, c.y - Math.sin(m) * t);
            n > t && (a.x = q.x,
            a.y = q.y);
            var r = b.point2D(0, 0)
              , A = b.point2D(0, 0);
            if (r.x = c.x ? c.x - a.x : a.x,
            ...
            m > o) {
                if (z.x = z.x + Math.abs(z.y * r.y / r.x),
                z.y = 0,
                Math.round(z.x * Math.tan(p - m)) < u)
                    return a.y = Math.sqrt(Math.pow(u, 2) + 2 * A.x * r.x),
                    d && (a.y = u - a.y),
                    C();
                var D = p - m
                  , E = B - u / Math.sin(D);
                x = b.point2D(Math.round(E * Math.cos(D)), Math.round(E * Math.sin(D))),
                e && (x.x = -x.x),
                d && (x.y = -x.y)
            }
            ...
            var H = F * Math.cos(2 * m)
              , I = F * Math.sin(2 * m);
            if (y = b.point2D(Math.round(e ? F - H : f + H), Math.round(d ? I : u - I)),
            s.options.gradients) {
                var J = v._endPoint(a.corner);
                i = Math.sqrt(Math.pow(J.x - a.x, 2) + Math.pow(J.y - a.y, 2)) / t,
                g = Math.min(100, F * Math.sin(m)),
                h = 1.3 * Math.min(F, G)
            }
            return z.x = Math.round(z.x),
            z.y = Math.round(z.y),
            !0
        }, D = function(a, c, j, k) {
            var l = ["0", "auto"]
            ...
            if (r.ipage.css(o).transform(b.rotate(k) + b.translate(a.x + p, a.y, A), q),
            ...
            s.options.gradients) {
                ...
                }).transform(b.translate(D, 0, A) + b.rotate(C) + b.scale(g / 100, 1, A), z),
                d ? e ? (C = -270 - k,
                h = -h,
                D = t - f - 20,
                z = "20% 25%") : (C = -90 - k,
        ...
        switch (r.point = b.peelingPoint(a.corner, a.x, a.y),
        a.corner) {
        case "l":
            m = a.y - r.startPoint.y,
            n = a.x,
            q = Math.atan2(m, n),
            q > 0 ? (j = r.startPoint.y,
            k = Math.sqrt(n * n + m * m),
            l = 2 * j * Math.sin(q) + k,
            a.x = l * Math.cos(q),
            a.y = l * Math.sin(q),
        ...
        case "r":
            ...
            d = !0,
            C(),
            D(b.point2D(-z.x, z.y), [0, 0, 0, 1], [0, 0], -w)) : (j = u - r.startPoint.y,
            k = Math.sqrt(n * n + m * m),
            l = 2 * j * Math.cos(o - q) + k,
            a.x = t - l * Math.cos(q),
            a.y = u - l * Math.sin(q),
    ...
    q.prototype._hardSingle = function(a) {
        var c, d = this.$el.data("f"), e = d.turnData;
        ...
        d.ipage.css(b.addCssWithPrefix({
    ...
    q.prototype._hardDouble = function(a) {
        var c = this.$el.data("f")
          ...
          , e = this.$el.width();
        this.$el.height();
        var f, g, h, i, j, k, l, m = "l" == a.corner, n = this._startPoint(a.corner), o = d.totalPages, p = c["z-index"] || o, q = {
            overflow: "visible"
        };
        ...
        d.pageWrap[u].css(b.addCssWithPrefix({
            overflow: "visible",
        ...
        d.options.gradients) {
            if (g) {
                ...
                c.ogradient.parent()[0] != w.ipage[0] && c.ogradient.appendTo(w.ipage),
                c.ogradient.css({
                    left: f,
            ...
            b.gradient(c.igradient, b.point2D(100 * h, 0), b.point2D(100 * (-h + 1), 0), [[0, "rgba(0,0,0,0.3)"], [1, "rgba(0,0,0,0)"]], 2)
        }
    ...
    r.prototype.value = function(a, c) {
        ...
        if (void 0 === a)
            return d.value;
        var e;
        if (a = Math.min(d.options.max, Math.max(d.options.min, a)),
        a = Math.round(a / d.options.step),
        a *= d.options.step,
        d.pressed)
            a != d.pvalue && (c || this._trigger("slide", a) != b.EVENT_PREVENTED) && (e = 100 * ((a - d.options.min) / (d.options.max - d.options.min)),
            ...
            f ? (e = 100 * ((a - d.options.min) / (d.options.max - d.options.min)),
            d.value = a) : e = 100 * ((d.value - d.options.min) / (d.options.max - d.options.min)),
            d.verticalStyle ? this.$el.find(".progress").height(e + "%") : this.$el.find(".progress").width(e + "%")
        } else
            c || this._trigger("valueUnchanged");
        return this.$el
    }
    ,
    ...
    r.prototype._eventPress = function(c) {
        var d, e, f = this._data, g = this.$el.find(".progress").parent();
        f.pressed = !0,
        f.pvalue = null,
        f.verticalStyle ? (d = b.eventPoint(c).y - g.offset().top,
        this.$el.addClass("changing"),
        e = g.height()) : (d = b.eventPoint(c).x - g.offset().left,
        this.$el.addClass("changing"),
        e = g.width()),
    ...
    r.prototype._eventMoving = function(a) {
        ...
        if (d.pressed && !d.disabled) {
            ...
            if (d.verticalStyle ? (d.offset = b.eventPoint(a).y - e.offset().top,
            c = e.height()) : (d.offset = b.eventPoint(a).x - e.offset().left,
            c = e.width()),
    ...
    r.prototype.options = function(b) {
        var c = this._data;
        return void 0 === b ? c.options : (c.options = a.extend(c.options, b),
        void 0)
    }
    ,
    ...
    var s = b.UIComponent(function(c) {
        if (!c.flipbook)
            throw b.turnError("Miniatures: Flipbook required");
        var d = this._data;
        d.pages = [],
        d.reusablePages = [],
    ...
    s.prototype._findPage = function(a) {
        for (var b = this._data, c = 0; c < b.pages.length; c++)
            if (b.pages[c].pageNum == a)
                return b.pages[c];
        return null
    }
    ,
    s.prototype._update = function(a, b) {
        var c, d, e = this._data, f = a - 1, g = !0;
        if (!(e.focusedPage == a && e.done && !b || 1 > a || a > e.$flipbook.turn("pages") || (e.prevFocusedPage = e.focusedPage,
        e.focusedPage = a,
        e.disabled))) {
            for (e.focusedView = e.$flipbook.turn("view", e.focusedPage, !0),
            this._updateQueueReusablePages(),
            e.$pageNumber.html(e.focusedView.join("-")); this._isPageVisible(f); )
            ...
            for (f = a; (d = this._isPageVisible(f)) || g && f <= e.totalPages; )
                d && (c = this._findPage(f) || this._reusablePage(),
                null === c && (c = this._addMiniature()),
                this._updatePage(f, c, !0),
                g = !1),
                f++
    ...
    s.prototype._updateQueueReusablePages = function() {
        for (var a, b = this._data, c = 0; c < b.pages.length; c++)
            a = b.pages[c],
            null !== a.pageNum && this._isPageVisible(a.pageNum, b.focusedPage) || (this._updatePage(a.pageNum, a, !0),
    ...
    s.prototype._updatePage = function(b, c, d) {
        var e = this
          ...
          , g = c.$el;
        if (null === b)
            this._updatePageX(c, -1e3);
        else {
            var h = this._getPageOffsetLeft(b);
            d && b != c.pageNum ? (g.removeClass("animated-page"),
            this._updatePageX(c, this._getPageOffsetLeft(b, f.prevFocusedPage)),
            setTimeout(function() {
                g.addClass("animated-page"),
                e._updatePageX(c, h)
            }, 0)) : (d && f.done ? g.addClass("animated-page") : g.removeClass("animated-page"),
    ...
    s.prototype._updatePageX = function(a, c) {
        a.x = c,
        a.$el.css(b.addCssWithPrefix({
            "@transform": "translate3d(" + c + "px, 0px, 0px)"
        }))
    }
    ,
    s.prototype._getPageOffsetLeft = function(a, b) {
        var c, d, e = this._data, f = "single" == e.$flipbook.turn("display");
        if (b = b || e.focusedPage,
        f)
            return e.scrollerWidth / 2 - e.pageWidth / 2 + (a - b) * (e.pageWidth + e.pageMargin) + e.offsetX;
        var g, h, i = e.$flipbook.turn("view", b, !0), j = b == a ? i : e.$flipbook.turn("view", a, !0), k = e.scrollerWidth / 2 - i.length * e.pageWidth / 2;
        if (a >= b) {
            for (g = i[i.length - 1],
            h = j[0] - 1,
            c = g; h >= c; )
    ...
    s.prototype._eventDelegation = function(b) {
        var c = this._data;
        b ? c.disabled || c.hasListeners || (c.hasListeners = !0,
        a(window).on("resize", a.proxy(this, "_eventResize")),
        this.$el.on("tap", ".ui-page", a.proxy(this, "_eventTap")),
        this.$el.on("vmousedown", a.proxy(this, "_eventPress"))) : (c.hasListeners = !1,
    ...
    s.prototype._eventPageTurned = function(a, b) {
        var c = this._data;
        c.listenToFlipbook && (c.offsetX = 0,
        this._update(b))
    }
    ,
    ...
    s.prototype._eventTap = function(b) {
        var c, d = this._data, e = a(b.currentTarget);
    ...
    s.prototype._eventRelease = function() {
        var c = this._data;
        if (a(document).off("vmousemove", this._eventMove).off("vmouseup", this._eventRelease),
        c.moving) {
            var d = c.offsetX;
            c.offsetX = 0;
    ...
    t.prototype._eventDelegation = function(b) {
        b ? (this.$el.on("vmouseover", this._data.options.selector, a.proxy(this, "_eventHover")),
        this.$el.on("vmouseout", this._data.options.selector, a.proxy(this, "_eventNoHover"))) : (this.$el.off("vmouseover", this._eventHover),
    ...
    t.prototype._showHint = function(c) {
        ...
        if (d && "" !== d) {
            ...
            if (this._trigger("willShowHint", c) == b.EVENT_PREVENTED)
                return;
            e.$currentTarget && (e.$currentTarget.removeClass("has-hint"),
            e.$currentTarget = null),
            e.$tooltip || (e.$tooltip = a("<div />", {
                "class": f
            }),
            e.$tooltip.hide(),
            ...
            for (var i, j = c.offset(), k = c.width(), l = c.height(), m = a(window).width(), n = a(window).height(), o = {
                ...
                if (o.x >= 0 && o.x + g <= m && o.y >= 0 && o.y + h <= n)
                    break
            }
            e.$tooltip.css({
                top: o.y,
    ...
    t.prototype.options = function(b) {
        return void 0 === b ? this._data.options : (this._data.options = a.extend(this._data.options, b),
        this.$el)
    }
    ,
    ...
    u.prototype._getContentSize = function(a) {
        ...
        return a || this.$el.hide(),
        c
    }
    ,
    u.prototype.selectItem = function(a, c) {
        var d = this._data;
        return 0 > a || a >= d.$items.length ? !1 : c || this._trigger("itemSelected", a) != b.EVENT_PREVENTED ? (null !== d.selectedItem && d.$items[d.selectedItem].removeClass("ui-selected-item"),
        d.selectedItem = a,
    ...
    u.prototype.clearSelection = function() {
        var a = this._data;
        return null !== a.selectedItem && a.$items[a.selectedItem].removeClass("ui-selected-item"),
        a.selectedItem = null,
        this.$el
    }
    ,
    ...
    u.prototype.hide = function() {
        var b = this;
        return a(document).off("vmousedown", this.hide),

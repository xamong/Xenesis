...
test('xenesisAgentDeskControl keeps connection catalogs and CR path inventory out of the planner file', () => {
  ...
  assert.match(source, /XENESIS_NATURAL_SAFETY_CONTEXT_WORDS/);
  assert.match(source, /XENESIS_NATURAL_ACCESS_GROUP_CONTEXT_WORDS/);
  assert.match(source, /XENESIS_NATURAL_MESSENGER_PAIRING_CONTEXT_WORDS/);
  ...
  assert.match(source, /XENESIS_NATURAL_PROVIDER_AGGREGATE_STATUS_ACTION_DESCRIPTORS/);
  ...
  assert.match(source, /XENESIS_NATURAL_PROVIDER_AGGREGATE_OPEN_ACTION_DESCRIPTORS/);
